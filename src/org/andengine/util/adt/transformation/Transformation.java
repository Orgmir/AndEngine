...
/**
 * <p>
 * This class is basically a java-space replacement for the native
 * {@link android.graphics.Matrix} class.
 * </p>
 * 
 * <p>
 * Math taken from <a
 * href="http://www.senocular.com/flash/tutorials/transformmatrix/"
 * >senocular.com</a>.
 * </p>
 * 
...
public class Transformation {
  ...
  public String toString() {
    return "Transformation{[" + this.a + ", " + this.c + ", " + this.tx + "][" + this.b + ", " + this.d + ", "
        + this.ty + "][0.0, 0.0, 1.0]}";
  }
  ...
  public final void postConcat(final Transformation pTransformation) {
    this.postConcat(pTransformation.a, pTransformation.b, pTransformation.c, pTransformation.d, pTransformation.tx,
        pTransformation.ty);
  }

  private void postConcat(final float pA, final float pB, final float pC, final float pD, final float pTX,
      final float pTY) {
    final float a = this.a;
    final float b = this.b;
    final float c = this.c;
  ...
  public final void preConcat(final Transformation pTransformation) {
    this.preConcat(pTransformation.a, pTransformation.b, pTransformation.c, pTransformation.d, pTransformation.tx,
        pTransformation.ty);
  }

  private void preConcat(final float pA, final float pB, final float pC, final float pD, final float pTX,
      final float pTY) {
    final float a = this.a;
    final float b = this.b;
    final float c = this.c;
