...
public class BuildableBitmapTextureAtlas extends BuildableTextureAtlas<IBitmapTextureAtlasSource, BitmapTextureAtlas> {
  ...
  /**
   * @param pBitmapTextureFormat use {@link BitmapTextureFormat#RGBA_8888} or
   *          {@link BitmapTextureFormat#RGBA_4444} for a
   *          {@link BitmapTextureAtlas} with transparency and
   *          {@link BitmapTextureFormat#RGB_565} for a
   *          {@link BitmapTextureAtlas} without transparency.
   */
  public BuildableBitmapTextureAtlas(final TextureManager pTextureManager, final int pWidth, final int pHeight,
   ...
   * Uses {@link BitmapTextureFormat#RGBA_8888}.
   * 
   * @param pTextureStateListener to be informed when this
   *          {@link BitmapTextureAtlas} is loaded, unloaded or a
   *          {@link ITextureAtlasSource} failed to load.
   */
  public BuildableBitmapTextureAtlas(final TextureManager pTextureManager, final int pWidth, final int pHeight,
      final ITextureAtlasStateListener<IBitmapTextureAtlasSource> pTextureStateListener) {
   ...
   */
  public BuildableBitmapTextureAtlas(final TextureManager pTextureManager, final int pWidth, final int pHeight,
      final TextureOptions pTextureOptions) throws IllegalArgumentException {
   ...
   */
  public BuildableBitmapTextureAtlas(final TextureManager pTextureManager, final int pWidth, final int pHeight,
      final BitmapTextureFormat pBitmapTextureFormat, final TextureOptions pTextureOptions)
  ...
  public BuildableBitmapTextureAtlas(final TextureManager pTextureManager, final int pWidth, final int pHeight,
      ...
      final ITextureAtlasStateListener<IBitmapTextureAtlasSource> pTextureStateListener)
      throws IllegalArgumentException {
    super(new BitmapTextureAtlas(pTextureManager, pWidth, pHeight, pBitmapTextureFormat, pTextureOptions,
